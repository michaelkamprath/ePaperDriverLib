...
void setup() {
#if defined( ESP8266 )
	device = new ePaperDisplay( GDEW026Z39, D1, D2, D3, D8 );
#elif defined ( ESP32 )
	device = new ePaperDisplay( GDEW026Z39, 21, 2, 4, 5 );
#elif defined(__AVR_ATmega1284__) || defined(__AVR_ATmega1284P__)
	// assume using MightyCore for the ATmega1284
	device = new ePaperDisplay( GDEW026Z39, PIN_PB1, PIN_PB2, PIN_PB3, PIN_PB4 );
#else
	device = new ePaperDisplay( GDEW026Z39, 3, 4, 5, 10 );
#endif
}
...
void loop() {
	...
	const __FlashStringHelper *str2 = F("152 x 296 pixels");
	int16_t x1, y1;
	uint16_t w, h;
